        ...
        render() {
            ...
            return (
                <div className="info-card" style={this.getStyle(this.props.infoCard)}>
                    <img src={closeIcon} className="close" alt="关闭" title="关闭"
              ...
              <img src={this.state.elevator ? elevatorActive : elevatorInactive} alt="无障碍电梯" title="无障碍电梯"
                   id="elevator"/>
              <img src={this.state.entranceInfo ? entranceActive : entranceInactive} alt="出入口" title="出入口"
                   id="entranceInfo"/>
            </span>
                    </div>
                    <div className="container">
                        <TimeSheet timesheet={this.props.infoCard.timesheet}
                                   ...
                                   currentLine={this.props.infoCard.currentLine} changeLine={(line) => {
                            this.changeLine(line)
                        }}/>
                        <div className="info-container"
                             style={this.getContainerStyle(this.state.line, this.state.timesheetActive)}
                             dangerouslySetInnerHTML={{__html: this.getInfo()}}></div>
                    </div>
                </div>
            )
        }
